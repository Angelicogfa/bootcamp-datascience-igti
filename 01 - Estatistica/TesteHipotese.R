...
# Análise Estatística de Dados – Página 105 de 177
###########################################################
...
hist(va_normal)
#Observe como os dados não se distribuem em torno de um valor médio exibindo
# padrão assimétrico
hist(va_nao_normal)
# Visualize o QQ-Plot
...
#Esse é o aspecto de uma distribuição t com n observações e com n - 1 graus deliberdade
n <- 5
...
# H0: O fato do cliente estar ou não com criança não tem relação com o fato de
comprar ou não comprar
# H1: O fato do cliente estar ou não com criança tem relação com fato de comprar ou
não comprar
rm(list = ls())
