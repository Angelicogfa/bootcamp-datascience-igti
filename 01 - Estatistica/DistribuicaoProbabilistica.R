...
# (prob) de sucesso. # É útil para realizar experimentos. Podemos simular qual a frequencia esperada de vendas a cada dez clientes ?
...
# prob é o número de sucesso em cada uma das tentativashist(va_binomial)
